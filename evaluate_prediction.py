...
def main():
    ...
    for dev_id, dev_tensor, dev_passage, dev_sent in zip(dev_ids, dev_text_tensor, dev_passages, dev_text):
        pred_linearized = evaluate(dev_tensor, model_r, attn_r, dev_sent, dev_passage)
